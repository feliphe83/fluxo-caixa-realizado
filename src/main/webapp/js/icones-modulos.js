...
(function (global) {
  ...
  var PISTAS = [
    ...
    [/parada|moagem/,                                                          'alert'],
    [/mapa|talh|geo/,                                                          'map'],
    [/cana|safra|colheita|agric|plantio/,                                      'trending-up'],
  ...
  /** Nome do ícone para um módulo: o cadastrado, ou o deduzido do texto. */
  function nomeDoModulo(mod) {
    if (mod && mod.icone && CORPOS[mod.icone]) return mod.icone;
