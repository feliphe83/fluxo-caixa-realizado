...
<html>
    ...
    try{
        ...
        rset = stmt.executeQuery("SELECT '0' tipo, '1' tipo2, ' Hoje' periodo, to_char(trunc(sysdate),'dd/mm/rrrr') datini, to_char(trunc(sysdate),'dd/mm/rrrr') datfin, 0 horini, 23 horfin, \n" +
                                 ...
                                 "       avg(pesliq) pesliq, 0 pcc, 0 atr, 0 ar, 0 pureza, '' tq " +
                                 ...
                                 "union all \n" +
                                 " \n" +
                                 "select '5' tipo, '6' tipo2, '00-06h' periodo, to_char(trunc(sysdate),'dd/mm/rrrr') datini, to_char(trunc(sysdate),'dd/mm/rrrr') datfin, 0 horini, 5 horfin, \n" +
                                 "       sum(iec.pesoliquido) pesliq, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.POL_CANA * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) PCC, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.ATR * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) ATR, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.AR_CANA * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) AR, \n" +
                                 ...
                                 "union all \n" +
                                 " \n" +
                                 "select '5' tipo, '7' tipo2, '06-12h' periodo, to_char(trunc(sysdate),'dd/mm/rrrr') datini, to_char(trunc(sysdate),'dd/mm/rrrr') datfin, 6 horini, 11 horfin, \n" +
                                 "       sum(iec.pesoliquido) pesliq, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.POL_CANA * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) PCC, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.ATR * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) ATR, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.AR_CANA * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) AR, \n" +
                                 ...
                                 "union all  \n" +
                                 "  \n" +
                                 "select '5' tipo, '8' tipo2, '12-18h' periodo, to_char(trunc(sysdate),'dd/mm/rrrr') datini, to_char(trunc(sysdate),'dd/mm/rrrr') datfin, 12 horini, 17 horfin, \n" +
                                 "       sum(iec.pesoliquido) pesliq, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.POL_CANA * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) PCC, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.ATR * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) ATR, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.AR_CANA * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) AR, \n" +
                                 ...
                                 "union all  \n" +
                                 "  \n" +
                                 "select '5' tipo, '9' tipo2, '18-24h' periodo, to_char(trunc(sysdate),'dd/mm/rrrr') datini, to_char(trunc(sysdate),'dd/mm/rrrr') datfin, 18 horini, 23 horfin, \n" +
                                 "       sum(iec.pesoliquido) pesliq, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.POL_CANA * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) PCC, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.ATR * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) ATR, \n" +
                                 "       round(DECODE(SUM(A_PCTS.PESOLIQUIDO),0,0,SUM(A_PCTS.AR_CANA * A_PCTS.PESOLIQUIDO )/SUM(A_PCTS.PESOLIQUIDO) ),4) AR, \n" +
             ...
             while (rset.next()){
                 ...
                 if (!sTipo.equals(rset.getString("tipo"))){
                     ...
                     if (rset.getString("tipo").equals("5") && lResumoHora){
                 ...
                 out.println("<td align='right'>");
                 out.println((rset.getString("pcc") == null?" ":nf2.format(rset.getFloat("pcc"))));
                 out.println("</td>");
                 out.println("<td align='right'>");
        ...
        //
             ...
             while (rset.next()){
                 ...
                 out.println("<td align='right'>");
                 out.println((rset.getString("pcc") == null?" ":nf3.format(rset.getFloat("pcc"))));
                 out.println("</td>");
                 out.println("<td align='right'>");
                 out.println((rset.getString("atr") == null?" ":nf3.format(rset.getFloat("atr"))));
                 out.println("</td>");
                 out.println("<td align='right'>");
                 out.println((rset.getString("ar") == null?" ":nf3.format(rset.getFloat("ar"))));
                 out.println("</td>");
                 out.println("<td align='right'>");
                 out.println((rset.getString("pureza") == null?" ":nf3.format(rset.getFloat("pureza"))));
                 out.println("</td>");
                 out.println("<td align='right'>");
